...
public class XfccServerInterceptorTest {
    ...
    public void parseSimpleHeaderWorks() {
        ...
        List<XfccServerInterceptor.XForwardedClientCert> certs = XfccServerInterceptor.parse(header);
        ...
        assertThat(certs.get(0).getSubject()).isNull();
    }
    @Test
    ...
    public void endToEndTest() {
        AtomicReference<List<XfccServerInterceptor.XForwardedClientCert>> certs = new AtomicReference<>();
