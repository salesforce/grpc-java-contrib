...
public abstract class Generator {
    ...
    /**
     * Executes a mustache template against a context object to generate an output string.
     * @param resourcePath Embedded resource template to use.
     * @param context Context object to bind the template to.
     * @return The string that results.
     */
    protected String applyTemplate(String resourcePath, Object context) {
